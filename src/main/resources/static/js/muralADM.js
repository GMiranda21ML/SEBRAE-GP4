document.addEventListener('DOMContentLoaded', () => {
            ...
            card.innerHTML = `
                <div class="data-details">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                        <h3 class="data-title" style="margin: 0; font-size: 1.1em; font-weight: bold; color: #333;">${sugestao.nomeAutor || 'Usuário'}</h3>
                        <small style="color: #888; font-size: 0.85em;">${dataFormatada}</small>
                    </div>
                    <p style="font-size: 1em; color: #555; line-height: 1.5; white-space: pre-wrap; margin-bottom: 20px;">${sugestao.texto}</p>
                </div>
    ...
    // --- Filtro (Opcional - Front-end simples) ---
    if (filtroInput) {
